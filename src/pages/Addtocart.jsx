...
function Addtocart() {
  ...
  // Load cart from server on mount — this must run unconditionally,
  // BEFORE any early return, or React throws a "rendered fewer hooks" error.
  useEffect(() => {
    dispatch(getCart());
  }, [dispatch]);

  // Derived totals — computed from cartItems in Redux state, not a
  // free-floating `cartTotal` that was never declared anywhere.
      ...
      <div className="checkout-success-page">
        <div className="success-card">
          ...
          <p className="success-message">
            Thank you for choosing VK Stich Studio. Your order has been
            registered in our system. A tailoring associate will contact you
            shortly to coordinate fabrics and confirm styling.
          </p>
          <div className="success-actions">
            <button
              onClick={() => navigate("/bookappointment")}
              className="cta-btn book-cta"
            >
      ...
      <div className="cart-container-main">
        {loading ? (
          ...
          <div className="empty-cart-state">
            ...
            <p>
              You haven't added any designer garments to your cart yet. Explore
              our luxury collection to begin.
            </p>
          ...
          <>
            <div className="cart-header-title">
              ...
              <p>
                Review your selection before checkout. Selected standard sizes
                or custom fits.
              </p>
            </div>
              ...
              <div className="cart-summary-column">
                <div className="summary-card">
                  ...
                  >
                    ...
                    {!promoApplied && (
                      <p className="promo-hint">
                        Use code <strong>WELCOME10</strong> (10% off) or{" "}
                        <strong>VKSTUDIO</strong> (15% off)
                      </p>
                    )}
                  </form>
                  ...
                  <p className="checkout-trust-badge">
                    🔒 Safe & secure order booking. No advance payment required
                    for custom fitting consultation.
                  </p>
                </div>
              </div>
            </div>
